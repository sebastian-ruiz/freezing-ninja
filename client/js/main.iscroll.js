...
var myScroll;
var myScrollList
var scrollingPages = false;
var scrollingList = false;
function loaded () {
    console.log("running loaded");
    var documentWidth = $(window).width();
    var documentHeight = $(window).height();
    var pageHeight = documentHeight-96;
    var pageWidth = documentWidth;
    var numPages = $("#scroller .page-wrapper").length;

    $('#pages-wrapper').css({'height': pageHeight+'px'});
    $('.page-wrapper').css({'width': pageWidth+'px'});
    $('#viewport').css({'width': pageWidth+'px'});
    $('#scroller').css({'width': pageWidth*numPages+'px'});

    var scrollLock = false;

	myScroll = new IScroll('#pages-wrapper', {
		scrollX: true,
		scrollY: false,
		momentum: false,
		snap: true,
    ...
    myScrollList = new IScroll('#list-wrapper', {
        mouseWheel: true,
        scrollX: false,
        scrollY: true

    });
    myScrollList.on('scrollStart', function () {
        scrollingList = true;
        console.log('scrollingList');
    });
    myScrollList.on('scrollEnd', function () {
        scrollingList = false;
        console.log("Not scrolling list");
        myScroll.enable();
    });
...
var lockHorizontally = function () {
    console.log("horizontal lock");
    if(scrollingPages) {
        myScrollList.disable();
    }else {
        myScrollList.enable();
    }
}
var lockVertically = function () {
    console.log("vertical lock");
    if(scrollingList) {
        myScroll.disable();
    }else {
        myScroll.enable();
